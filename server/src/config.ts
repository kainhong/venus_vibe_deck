...
export const config = {
  ...
  voice: {
    ...
    asrBaseUrl: process.env.VOICE_ASR_BASE_URL ?? 'wss://dashscope.aliyuncs.com/compatible-mode/v1/realtime',
    ...
    llmBaseUrl: process.env.VOICE_LLM_BASE_URL ?? 'https://dashscope.aliyuncs.com/compatible-mode/v1',
    llmApiKey: process.env.VOICE_LLM_API_KEY ?? '',
    llmModel: process.env.VOICE_LLM_MODEL ?? 'qwen-plus',
